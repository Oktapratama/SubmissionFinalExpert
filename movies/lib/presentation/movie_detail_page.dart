...
import '../presentation/bloc/detail_movies/movie_detail_bloc.dart';
import '../presentation/bloc/recommendations_movies/movie_recommendations_bloc.dart';

class PageDetailMovie extends StatefulWidget {
  static const ROUTE_NAME = '/detailMovie';
  final int id;
  const PageDetailMovie({Key? key, required this.id}) : super(key: key);
