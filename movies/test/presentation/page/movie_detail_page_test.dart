...
void main() {
  ...
  testWidgets('page should display circular progress indicator when loading',
    ...
    await tester.pumpWidget(_makeTestableWidget(const PageDetailMovie(
      id: testId,
    )));
    await tester.pump();
  ...
  testWidgets('should widget display which all required',
    ...
    await tester
        .pumpWidget(_makeTestableWidget(const PageDetailMovie(id: testId)));
    await tester.pump();

    expect(find.text('Watchlist Movies'), findsOneWidget);
    expect(find.text('Overview'), findsOneWidget);
    expect(find.text('Recommendations Movies'), findsOneWidget);
    expect(find.byKey(const Key('movie_content_detail')), findsOneWidget);
  });
